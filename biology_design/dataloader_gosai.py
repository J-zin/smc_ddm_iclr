...
# Set DRAKES_DATA_ROOT to the path of your downloaded data_and_model directory.
# See README.md for setup instructions.
base_path = os.environ.get('DRAKES_DATA_ROOT')
if base_path is None:
    raise EnvironmentError(
        "Environment variable DRAKES_DATA_ROOT is not set. "
        "Please set it to the path of your downloaded data_and_model directory. "
        "Example: export DRAKES_DATA_ROOT=/path/to/data_and_model"
    )
