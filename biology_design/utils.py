# Taken from https://github.com/ChenyuWang-Monica/DRAKES/blob/master/drakes_dna/utils.py
...
def get_metadata(local_vars, ignore_hidden=False):
    metadata = {}
    primitive_types = (int, float, bool, str)
    for var, val in local_vars.items():
        if ignore_hidden and var.startswith('_'):
            continue
